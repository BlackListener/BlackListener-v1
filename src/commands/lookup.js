...
module.exports = class extends Command {
  ...
  async run(msg, settings, lang) {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField(lang.lookup.bannedFromUser, userConfig.bannedFromUser ? userConfig.bannedFromUser.join('\n') : lang.lookup.not_banned)
      .addField(lang.lookup.probes, userConfig.probes ? userConfig.probes.join('\n') : lang.lookup.not_banned)
      .addField(lang.lookup.reasons, userConfig.reasons ? userConfig.reasons.join('\n') : lang.lookup.not_banned)
