...
module.exports = class extends Command {
  ...
  async run(msg, [user]) {
    ...
    const embed = new Discord.MessageEmbed()
      ...
      .addField(msg.language.get('COMMAND_LOOKUP_REP'), userConfig.rep)
      ...
      .addField(msg.language.get('COMMAND_LOOKUP_BANNEDFROMUSER'), userConfig.bannedFromUser.join('\n') || msg.language.get('COMMAND_LOOKUP_NOT_BANNED'))
      .addField(msg.language.get('COMMAND_LOOKUP_PROBES'), userConfig.probes.join('\n') || msg.language.get('COMMAND_LOOKUP_NOT_BANNED'))
      .addField(msg.language.get('COMMAND_LOOKUP_REASONS'), userConfig.reasons.join('\n') || msg.language.get('COMMAND_LOOKUP_NOT_BANNED'))
