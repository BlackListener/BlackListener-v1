...
module.exports = class extends Command {
  ...
  async run(msg) {
    ...
    msg.channel.send(new Discord.MessageEmbed()
      ...
      .addField(msg.language.get('COMMAND_INFO_SERVERS'), client.guilds.size, true)
      .addField(msg.language.get('COMMAND_INFO_USERS'), client.users.size, true)
      .addField(msg.language.get('COMMAND_INFO_CREATEDBY'), owner)
